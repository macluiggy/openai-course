...
const additionalPrompts = {
  a: `Use at most 50 words.`,
  b: `The description is intended for furniture retailers, 
  so should be technical in nature and focus on the 
  materials the product is constructed from.
  
  Use at most 50 words.`,
  c: `The description is intended for furniture retailers, 
  so should be technical in nature and focus on the 
  materials the product is constructed from.
...
// const additionalPrompt = additionalPrompts.c;
const additionalPrompt = additionalPrompts.d;
